          ...
          <div className="space-y-8">
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                Ещё вчера ваш тариф стоил <span className="font-semibold">600 ₽</span>, а сегодня за тот же пакет просят <span className="font-semibold">350 ₽</span> — естественно, это может раздражать.
              </p>
