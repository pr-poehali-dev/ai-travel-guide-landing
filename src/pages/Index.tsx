          ...
          <div className="space-y-8">
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                Чтобы у вас не зависали фильмы и рилсы, связь держалась и в офисе, и загородом, а интернет оставался быстрым и стабильным — даже при растущей нагрузке на сеть. По данным Минцифры, совокупный трафик фиксированных и мобильных сетей в РФ в 2024 году вырос примерно на <span className="font-semibold">24%</span> и продолжает расти в 2025-м.
              </p>
            </div>
